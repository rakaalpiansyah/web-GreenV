...
<body class="bg-gray-100" x-data="{ open: false, scrollY: 0, currentPath: '{{ url()->current() }}' }" @scroll.window="scrollY = window.scrollY">
    ...
    <div class="container mx-auto px-4">
        ...
        <div class="container mx-auto py-12 px-6 relative mt-16" data-aos="fade-down">
            <!-- Section: Jumlah Populasi Sampah Masyarakat Saat Ini -->
            <div class="bg-white p-8 rounded-lg shadow-lg mb-12">
                <h2 class="text-2xl font-bold text-gray-900 mb-4">Jumlah Populasi Sampah Masyarakat Saat Ini: Tantangan dan Solusi</h2>
                <p class="mb-4">Pertumbuhan populasi dan peningkatan konsumsi masyarakat telah mengakibatkan peningkatan jumlah sampah yang dihasilkan setiap hari. Masalah sampah menjadi salah satu tantangan lingkungan yang paling mendesak di berbagai negara di dunia. Artikel ini akan membahas jumlah populasi sampah masyarakat saat ini, faktor-faktor penyebab peningkatannya, serta solusi yang dapat diambil untuk mengatasi masalah tersebut.</p>
                
                <h3 class="text-xl font-semibold text-gray-900 mb-2">Jumlah Sampah yang Dihasilkan Masyarakat</h3>
                <p class="mb-4">Menurut data dari Bank Dunia, pada tahun 2020, dunia menghasilkan sekitar 2,01 miliar ton sampah padat perkotaan setiap tahunnya. Jumlah ini diperkirakan akan meningkat menjadi 3,4 miliar ton per tahun pada tahun 2050 jika tidak ada perubahan signifikan dalam kebijakan dan perilaku pengelolaan sampah. Negara-negara maju menyumbang sebagian besar dari jumlah sampah ini, meskipun negara berkembang juga menunjukkan peningkatan yang signifikan seiring dengan urbanisasi dan peningkatan standar hidup.</p>
                
                <h3 class="text-xl font-semibold text-gray-900 mb-2">Faktor Penyebab Peningkatan Jumlah Sampah</h3>
                <ul class="list-disc pl-6 mb-4">
                    <li class="mb-2">Urbanisasi dan Pertumbuhan Populasi: Peningkatan jumlah penduduk dan urbanisasi cepat di kota-kota besar menyebabkan peningkatan volume sampah. Kota-kota dengan populasi yang padat cenderung menghasilkan lebih banyak sampah per kapita.</li>
                    <li class="mb-2">Konsumsi Berlebihan: Gaya hidup modern yang cenderung konsumtif mendorong produksi barang sekali pakai dan kemasan yang berlebihan, meningkatkan jumlah sampah anorganik.</li>
                    <li class="mb-2">Kurangnya Kesadaran Lingkungan: Banyak masyarakat yang belum memiliki kesadaran tentang pentingnya pengelolaan sampah yang baik, termasuk pemilahan sampah dan daur ulang.</li>
                    <li class="mb-2">Kurangnya Infrastruktur Pengelolaan Sampah: Di banyak negara berkembang, infrastruktur untuk pengelolaan sampah masih kurang memadai, menyebabkan penumpukan sampah di tempat-tempat yang tidak seharusnya.</li>
                </ul>
    
                <h3 class="text-xl font-semibold text-gray-900 mb-2">Dampak Negatif dari Penumpukan Sampah</h3>
                <ul class="list-disc pl-6 mb-4">
                    <li class="mb-2">Pencemaran Lingkungan: Sampah yang tidak terkelola dengan baik dapat mencemari tanah, air, dan udara. Plastik dan bahan kimia berbahaya dari sampah dapat merusak ekosistem dan membahayakan kesehatan manusia.</li>
                    <li class="mb-2">Kesehatan Masyarakat: Penumpukan sampah dapat menjadi sarang bagi hama dan penyakit, serta menimbulkan bau yang tidak sedap yang dapat mempengaruhi kualitas hidup masyarakat sekitar.</li>
                    <li class="mb-2">Dampak Ekonomi: Biaya untuk mengelola dan membersihkan sampah yang menumpuk dapat sangat tinggi, membebani anggaran pemerintah dan masyarakat.</li>
                </ul>
    
                <h3 class="text-xl font-semibold text-gray-900 mb-2">Solusi untuk Mengatasi Masalah Sampah</h3>
                <ul class="list-disc pl-6 mb-4">
                    <li class="mb-2">Pengurangan Sampah di Sumbernya: Mengurangi produksi sampah dengan mengadopsi gaya hidup yang lebih berkelanjutan, seperti menggunakan barang-barang yang dapat digunakan kembali dan mengurangi konsumsi produk sekali pakai.</li>
                    <li class="mb-2">Daur Ulang dan Pemilahan Sampah: Meningkatkan praktik daur ulang dan pemilahan sampah di rumah tangga, serta membangun infrastruktur yang mendukung proses ini.</li>
                    <li class="mb-2">Pengomposan: Mengomposkan sampah organik untuk mengurangi volume sampah dan menghasilkan pupuk alami yang bermanfaat.</li>
                    <li class="mb-2">Peningkatan Kesadaran Masyarakat: Melakukan kampanye edukasi untuk meningkatkan kesadaran tentang pentingnya pengelolaan sampah yang baik.</li>
                    <li class="mb-2">Pengembangan Teknologi Pengolahan Sampah: Mengadopsi teknologi canggih untuk mengolah sampah menjadi energi atau bahan berguna lainnya.</li>
                    <li class="mb-2">Kebijakan dan Regulasi yang Ketat: Pemerintah harus menerapkan regulasi yang ketat dan memberikan insentif bagi masyarakat dan industri untuk mengelola sampah dengan lebih baik.</li>
                </ul>
            </div>
        </div>
