...
<body class="bg-gray-400" x-data="{ open: false, scrollY: 0, currentPath: '{{ url()->current() }}' }" @scroll.window="scrollY = window.scrollY">
    ...
    <div class="container mx-auto px-4">
        ...
        <div class="container mx-auto py-12 px-6 relative mt-14" data-aos="fade-down">
            <!-- Section: Pengolahan Sampah -->
            <div class="bg-white p-8 rounded-lg shadow-lg mb-12">
                <h2 class="text-2xl font-bold text-gray-900 mb-4">Mengoptimalkan Pengolahan Sampah untuk Lingkungan yang Lebih Bersih dan Sehat</h2>
                <p class="mb-4">Pengolahan sampah merupakan langkah kritis dalam menjaga kebersihan lingkungan dan mengurangi dampak negatifnya terhadap kesehatan manusia serta ekosistem. Dengan populasi dunia yang terus bertambah dan konsumsi yang meningkat, manajemen sampah yang efektif menjadi semakin penting. Artikel ini akan membahas berbagai metode pengolahan sampah serta pentingnya daur ulang dalam upaya menjaga keberlanjutan lingkungan.</p>
                
                <h3 class="text-xl font-semibold text-gray-900 mb-2">Jenis-jenis Sampah</h3>
                <p class="mb-4">Sampah dapat dibedakan menjadi beberapa jenis berdasarkan sifatnya, seperti organik (sisa makanan, daun, dll.), anorganik (plastik, kertas, logam), berbahaya (baterai, obat-obatan), dan lainnya. Setiap jenis sampah memerlukan penanganan yang berbeda sesuai dengan karakteristiknya untuk meminimalkan dampak negatifnya terhadap lingkungan.</p>
                
                <h3 class="text-xl font-semibold text-gray-900 mb-2">Tahapan Pengolahan Sampah</h3>
                <ul class="list-disc pl-6 mb-4">
                    <li class="mb-2"><strong>Pengumpulan:</strong> Langkah awal dalam pengolahan sampah adalah pengumpulan dari sumbernya, baik itu dari rumah tangga, perkantoran, atau industri.</li>
                    <li class="mb-2"><strong>Pemilahan:</strong> Setelah dikumpulkan, sampah perlu dipilah untuk memisahkan jenis-jenisnya. Pemilahan ini penting untuk memudahkan proses selanjutnya, seperti daur ulang.</li>
                    <li class="mb-2"><strong>Pengolahan Primer:</strong> Proses pengolahan awal bisa berupa penghancuran, pemadatan, atau komposisi untuk mempersiapkan sampah untuk tahap selanjutnya.</li>
                    <li class="mb-2"><strong>Pengolahan Sekunder:</strong> Meliputi berbagai metode seperti daur ulang, komposisi, dan pengolahan energi. Daur ulang khususnya merupakan langkah kunci untuk mengurangi jumlah sampah yang masuk ke tempat pembuangan akhir.</li>
                    <li class="mb-2"><strong>Pengolahan Tersier:</strong> Jika ada sisa sampah yang tidak dapat didaur ulang atau diolah kembali, proses ini meliputi pembakaran dengan teknologi yang ramah lingkungan atau pengolahan limbah berbahaya.</li>
                </ul>
    
                <h3 class="text-xl font-semibold text-gray-900 mb-2">Pentingnya Daur Ulang</h3>
                <p class="mb-4">Daur ulang adalah proses mengubah barang-barang bekas menjadi bahan baru yang dapat digunakan kembali. Manfaat daur ulang antara lain mengurangi jumlah sampah yang masuk ke tempat pembuangan akhir (TPA), menghemat sumber daya alam seperti air dan energi, serta mengurangi emisi gas rumah kaca.</p>
    
                <h3 class="text-xl font-semibold text-gray-900 mb-2">Teknologi dan Inovasi dalam Pengolahan Sampah</h3>
                <p class="mb-4">Berbagai teknologi dan inovasi terus dikembangkan untuk meningkatkan efisiensi dan keberlanjutan dalam pengolahan sampah. Contohnya adalah teknologi pembuangan sampah yang lebih baik, mesin pencacah sampah otomatis, dan metode pengolahan energi dari sampah.</p>
    
                <h3 class="text-xl font-semibold text-gray-900 mb-2">Peran Masyarakat dan Pemerintah</h3>
                <p class="mb-4">Pengolahan sampah bukan hanya tanggung jawab pemerintah, tetapi juga melibatkan partisipasi aktif masyarakat. Kampanye edukasi tentang pentingnya membuang sampah pada tempatnya, pemilahan sampah di rumah tangga, serta partisipasi dalam program daur ulang sangat diperlukan.</p>
    
                <p class="mb-4">Pengolahan sampah bukan sekadar menghilangkan sampah dari pandangan, tetapi sebuah proses yang melibatkan berbagai tahapan untuk mengurangi dampak negatifnya terhadap lingkungan. Dengan adopsi praktik daur ulang dan pengelolaan sampah yang efisien, kita dapat berkontribusi pada upaya menjaga kebersihan lingkungan dan keberlanjutan planet ini untuk generasi mendatang. Gotong royong antara pemerintah, industri, dan masyarakat sangat dibutuhkan agar tujuan ini dapat tercapai secara efektif dan berkelanjutan.</p>
            </div>
        </div>
